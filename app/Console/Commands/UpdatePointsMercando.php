...
class UpdatePointsMercando extends Command
{
     ...
     * @var string
     */
    protected $signature = 'get:update-points-mercando';
     ...
     * @var string
     */
    protected $description = 'Comando para actualizar puntos de mercando';
    ...
    {
        $api_url_good = 'https://'. env('API_KEY_MERCANDO') . ':' . env('API_PASSWORD_MERCANDO') . '@' . env('API_SHOP_MERCANDO');
        $client = new \GuzzleHttp\Client();

        $variants = Variant::where('shop', 'mercando')->get();
