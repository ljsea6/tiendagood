                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: white; font-family: 'Dosis'; text-align: center">
                                    <h1 style="margin: 0; font-family: 'Dosis', sans-serif; font-size: 34px; line-height: 125%; color: white; font-weight: bolder; ">¡Felicidades!. {{$usuario->nombre}} se ha inscrito con su código en su nivel: {{$nivel}}. 
</h1>
                                </td>
                            </tr>
                            <tr>
