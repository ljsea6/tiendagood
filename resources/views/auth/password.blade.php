...
<div class="container" style="height: 100%">
  ...
  {!! Form::open(['route' => 'reset', 'method' => 'POST', 'class' => 'form-access submit']) !!}
                ...
                <div class="col-xs-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" name="email" id="email" class="form-control campo-access" placeholder="Ingresa tu correo electronico">
                        </div>
                    </div>
...
$('.submit').on('submit',function(event){
        ...
        //
                ...
                if ($('#email').val() == '') {
                  ...
                  html: $('<div>').text('Lo sentimos, pero tiene que ingresar su correo.'),
                  animation: false,
                ...
                if (result_email.msg == 'email valido') {
                  swal({
                  title: 'Vuelva a intentarlo',
                  html: $('<div>').text('Lo sentimos, pero no hay ningún usuario registrado con este correo.'),
                  animation: false,
                  customClass: 'animated tada'
                  });
