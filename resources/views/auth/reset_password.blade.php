                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-family: sans-serif; font-size: 15px; line-height: 140%; color: white; font-family: 'Dosis'; text-align: center">
                                    <h1 style="margin: 0; font-family: 'Dosis', sans-serif; font-size: 34px; line-height: 125%; color: white; font-weight: bolder; ">Haga clic aquí para restablecer la contraseña:

                                   <a href="good.app/recuperar-contraseña/{{$token}}" style="background: #222222; border: 15px solid #222222; font-family: sans-serif; font-size: 13px; line-height: 110%; text-align: center; text-decoration: none; display: block; border-radius: 3px; font-weight: bold;" class="button-a">
